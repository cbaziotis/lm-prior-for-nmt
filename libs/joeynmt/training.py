...
from libs.joeynmt.model import build_model
from libs.joeynmt.batch import Batch
from libs.joeynmt.helpers import log_data_info, load_config, log_cfg, \
    store_attention_plots, load_checkpoint, make_model_dir, \
    make_logger, set_seed, symlink_update, ConfigurationError
from libs.joeynmt.model import Model
from libs.joeynmt.prediction import validate_on_data
from libs.joeynmt.loss import XentLoss
from libs.joeynmt.data import load_data, make_data_iter
from libs.joeynmt.builders import build_optimizer, build_scheduler, \
    build_gradient_clipper
from libs.joeynmt.prediction import test
...
if __name__ == "__main__":
    ...
    #                     default="configs/wmt18_entr_bpe.yaml",
    #                     type=str,
    #                     required=False,
    #                     help="Training configuration file (yaml).")
    # args = parser.parse_args()
    # # train(cfg_file=args.config)
    train(cfg_file="../configs/wmt18_entr_bpe.yaml")
