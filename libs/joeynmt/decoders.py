...
from libs.joeynmt.attention import BahdanauAttention, LuongAttention
from libs.joeynmt.encoders import Encoder
from libs.joeynmt.helpers import freeze_params, ConfigurationError, subsequent_mask
from libs.joeynmt.transformer_layers import PositionalEncoding, \
...
class RecurrentDecoder(Decoder):
    ...
    def _forward_step(self,
        ...
        outs, hidden = self.rnn(rnn_input, hidden)
        ...
        # x = outs.detach().cpu().numpy().squeeze()
        # y = query.detach().cpu().numpy().squeeze()
